...
class mae_ReportesAdmin(admin.ModelAdmin):
    ...
    list_display = (
    "id", "mae_gruporeportes", "mae_subgruporeportes", "nom_reporte", "usuario_crea", "fechaRegistro", "descripcion",
    "cuerpo_sql", "encabezados", "excel", "pdf", "csv", "grilla", "grafica", "estadoreg")
    search_fields = (
    "id", "mae_gruporeportes__id", "mae_subgruporeportes__id", "nom_reporte", "usuario_crea", "fechaRegistro",
    "descripcion", "cuerpo_sql", "encabezados", "excel", "pdf", "csv", "grilla", "grafica", "estadoreg")
    # Filtrar
    list_filter = (
    "mae_gruporeportes", "mae_subgruporeportes", "nom_reporte", "usuario_crea", "fechaRegistro", "descripcion", "excel",
    "pdf", "csv", "grilla", "grafica", "estadoreg")
